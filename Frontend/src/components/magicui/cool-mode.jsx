...
/**
 * @typedef {Object} BaseParticle
 * @property {HTMLElement | SVGSVGElement} element
...
/**
 * @typedef {Object} BaseParticleOptions
 * @property {string} [particle]
 * @property {number} [size]
 */

/**
 * @typedef {BaseParticle & { direction: number, speedHorz: number, speedUp: number, spinSpeed: number, spinVal: number }} CoolParticle
 */

/**
 * @typedef {BaseParticleOptions & { particleCount?: number, speedHorz?: number, speedUp?: number }} CoolParticleOptions
 */
...
/**
 * Applies particle effect to the provided element.
 * @param {HTMLElement} element
 * @param {CoolParticleOptions} [options]
 * @returns {() => void}
 */
 ...
 * @param {CoolParticleOptions} [props.options]
 */
